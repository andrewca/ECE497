This directory contains project files for Homework 3 from ECE497 by Chris Andrews

Temperature folder has the files that read from a temperature sensor over i2c
...
EtchaSketch folder contains the code that interfaces with an i2c led matrix
